  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="/course" title class="c-999 fsize14">影片列表</a>
        \
      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img height="375px" :src="course.cover" :alt="course.title" class="dis c-v-pic" />
          </section>
        </article>
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt c-attr-undis">
              <span class="c-fff fsize14">主演：{{course.teacherName}}&nbsp;&nbsp;&nbsp;</span>
            </section>
            ...
            <section class="c-attr-mt" v-if="Number(course.price) ===0||isBuy">
            ...
            <div class="i-box">
              <div>
                <section id="c-i-tabTitle" class="c-infor-tabTitle c-tab-title">
                  <a name="c-i" class="current" title="影片详情">影片详情</a>
                </section>
              </div>
                          ...
                          >
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              ...
                              <li
                                ...
                                v-if="Number(course.price) ===0||isBuy"
          ...
          <div class="i-box">
            <div>
              <section class="c-infor-tabTitle c-tab-title">
                <a title href="javascript:void(0)">主演</a>
              </section>
              <section class="stud-act-list">
                <ul style="height: auto;">
                  <li>
                    <div class="u-face">
                      <a href="#">
                        <img :src="course.avatar" width="50" height alt />
                      </a>
                    </div>
