    ...
    <section class="container">
      ...
      <section class="c-sort-box">
        <section class="c-s-dl">
          <dl>
            <dt>
              <span class="c-999 fsize14">影片类别</span>
            </dt>
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li>
          ...
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li v-for="(item,index) in subSubjectList" :key="index" :class="{active:twoIndex==index}" @click="searchTwo(item.id,index)">
              ...
              <li v-for="item in data.items" :key="item.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    />
                    <div class="cc-mask">
                      <a :href='"/course/"+item.id' title="立即观看" class="comm-btn c-btn-1">立即观看</a>
                    </div>
                  </section>
                  ...
                  <section class="mt10 hLh20 of">
                    ...
                    <!-- <span class="fl jgAttr c-ccc f-fA">
                      <i class="c-999 f-fA">{{item.viewCount}}学习</i>
                      |
