            ...
            <ul class="of">
              ...
              <div class="cc-l-wrap">
                <section class="course-img">
                  ...
                  <div class="cc-mask">
                    <a :href="'/course/'+course.id" title="立即观看" target="_blank" class="comm-btn c-btn-1">立即观看</a>
                  </div>
                </section>
...
asyncData({ params, error }) {
    return tacherApi.getTeacherInfo(params.id).then(response => {
